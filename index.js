...
output.textContent = "Shinzou wo Sasageyo!!!";
...
function playRound() {
  ...
  if (result == 0) {
    output.textContent = `It's a tie! You chose ${playerChoice} and The computer chose ${compChoice.Value}`;
  } else if (result == 1) {
...
function playGame() {
  ...
  computer.textContent = `Computer Score: ${compScore}`;
  if (playerScore == 5) {
    output.textContent = "You Won the Game and you've saved Mankind!";
    playerScore = 0;
    compScore = 0;
    player.textContent = `Player Score: ${playerScore}`;
    computer.textContent = `Computer Score: ${compScore}`;
  } else if (compScore == 5) {
    output.textContent = "You Lost the game. Sad!";
    playerScore = 0;
    compScore = 0;
    player.textContent = `Player Score: ${playerScore}`;
    computer.textContent = `Computer Score: ${compScore}`;
